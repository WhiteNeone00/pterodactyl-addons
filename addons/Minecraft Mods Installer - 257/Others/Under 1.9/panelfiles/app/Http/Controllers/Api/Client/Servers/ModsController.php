...
class ModsController extends ClientApiController
{
    ...
    /**
        ...
        public function curse(Request $request)
        {
            ...
            return Http::accept('application/json')->get('https://api.whee.lol/api/client/pterodactyl/mods', ['page' => $request->page, 'search' => $request->search, 'license' => $license, 'ip' => $request->ip(), 'type' => $request->type, 'game_versions' => $request->version, 'loaders' => $request->loader]);
        ...
        public function versions(Request $request)
        {
            ...
            return Http::accept('application/json')->get('https://api.whee.lol/api/client/pterodactyl/mods/versions', ['modId' => $request->modId, 'page' => $request->page, 'license' => $license, 'ip' => $request->ip(), 'type' => $request->type]);
        }
        ...
        public function description(Request $request)
        {
            ...
            return Http::accept('application/json')->get('https://api.whee.lol/api/client/pterodactyl/mods/description', ['modId' => $request->modId, 'license' => $license, 'ip' => $request->ip(), 'type' => $request->type]);
        }
        ...
        public function mcversions(Request $request)
        {
            ...
            return Http::accept('application/json')->get('https://api.whee.lol/api/client/pterodactyl/mods/getMcVersions', ['license' => $license, 'ip' => $request->ip()]);
        }
